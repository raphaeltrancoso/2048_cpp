...
#include <stdlib.h> 
#include <string>
#include "game2048_2.hpp"
using namespace std;

game2048_2::game2048_2(int s,int p){
	size = s;
	puissance = p;
	tab = new int*[size];
...
void game2048_2::drawGame(char* message){
	move(0,0);
...
void game2048_2::addRandomNumber(){
